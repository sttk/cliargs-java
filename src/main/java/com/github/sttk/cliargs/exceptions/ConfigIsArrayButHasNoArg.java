...
/**
 * Is the exception which indicates that an option configuration contradicts that the option can
 * take multiple arguments though it does not take option arguments.
 */
public class ConfigIsArrayButHasNoArg extends InvalidOption {
  private static final long serialVersionUID = 5559546614916639089L;
   ...
   */
  public ConfigIsArrayButHasNoArg(final String storeKey, final String name) {
